...
JNEXT.Template = function () {
	...
	self.init = function () {
		if (!JNEXT.require("libEvents")) {
			return false;
		}

		self.m_id = JNEXT.createObject("libEvents.TemplateJS");
	...
	self.start = function () {
		JNEXT.invoke(self.m_id, "start");
	};
	
	self.stop = function () {
		JNEXT.invoke(self.m_id, "stop");
	};
	
	self.getcount = function () {
		return JSON.parse(JNEXT.invoke(self.m_id, "getcount"));
	};
